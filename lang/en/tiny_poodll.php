...
$string['privacy:metadata:tiny_poodll_history'] = 'Stores Tiny Poodll recording history records.';
$string['privacy:metadata:tiny_poodll_history:userid'] = 'The user linked to the history record.';
$string['privacy:metadata:tiny_poodll_history:courseid'] = 'The course where the history record belongs.';
$string['privacy:metadata:tiny_poodll_history:filetitle'] = 'The title assigned to the media item.';
$string['privacy:metadata:tiny_poodll_history:recordertype'] = 'The recorder type used to create the item.';
$string['privacy:metadata:tiny_poodll_history:mediafilename'] = 'The filename of the stored media item.';
$string['privacy:metadata:tiny_poodll_history:mediaurl'] = 'The remote URL to the stored media item.';
$string['privacy:metadata:tiny_poodll_history:sourceurl'] = 'The remote URL to the source media item.';
$string['privacy:metadata:tiny_poodll_history:sourcemimetype'] = 'The MIME type of the source media.';
$string['privacy:metadata:tiny_poodll_history:subtitling'] = 'Whether subtitle generation was requested.';
$string['privacy:metadata:tiny_poodll_history:subtitleurl'] = 'The remote URL to generated subtitles.';
$string['privacy:metadata:tiny_poodll_history:language'] = 'The subtitle/transcription language used.';
$string['privacy:metadata:tiny_poodll_history:archived'] = 'Whether the item is marked as archived in history.';
$string['privacy:metadata:tiny_poodll_history:dateofentry'] = 'The timestamp when the history record was created.';
$string['privacy:metadata:tiny_poodll_history:userofentry'] = 'The user who created the history record.';
$string['privacy:metadata:tiny_poodll_history:dateofchange'] = 'The timestamp when the history record was last changed.';
$string['privacy:metadata:tiny_poodll_history:userofchange'] = 'The user who last modified the history record.';
$string['privacy:metadata:external'] = 'Tiny Poodll sends recording data to the Cloud Poodll service.';
$string['privacy:metadata:external:userid'] = 'The user ID associated with the recording request.';
$string['privacy:metadata:external:mediafilename'] = 'The media filename sent to Cloud Poodll.';
$string['privacy:metadata:external:mediaurl'] = 'The media URL stored by Cloud Poodll.';
...
$string['freetrial_desc'] = "Tiny Poodll is a premium Moodle plugin. A free trial can be set up in a couple of minutes without leaving your Moodle site. For details on pricing visit <a href='https://poodll.com/pricing'>Poodll.com</a>. ";
...
$string['cbsetupintro'] = "Tiny Poodll cannot run until the Poodll API user and secret have been set for this site. They are site wide settings, so you only need to do this once.";
...
$string['cbgotosettings'] = "Go to the Tiny Poodll settings page";
$string['cbcredentialssaved'] = "Your Poodll API credentials were saved and accepted.";
$string['cbnocredentialsset'] = "Tiny Poodll cannot run yet because the Poodll API user and secret have not been set for this site.";
