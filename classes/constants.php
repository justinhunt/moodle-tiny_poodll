...
class constants {
    ...
    const CLASS_REC_CONTAINER = 'tiny_poodll_rec_cont';
    const CLASS_REC_OUTER = 'tiny_poodll_rec_outer';
    const ID_REC = 'tiny_poodll_therecorder';
    const ID_UPDATE_CONTROL = 'tiny_poodll_updatecontrol';
